...
function ENT:Think()
	...
	if ACF.CurTime > self.NextLegalCheck then
		...
		self.Legal, self.LegalIssues = ACF_CheckLegal(self, self.Model, math.floor(self.EmptyMass), nil, true, true, true, true) -- mass-6, as mass update is granular to 5 kg
