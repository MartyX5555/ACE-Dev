...
function SWEP:InitBulletData()
    ...
    PlayerData.PropLength   = 7.75       --Volume of the case as a cylinder * Powder density converted from g to kg   
    PlayerData.ProjLength   = 60      --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
    PlayerData.Data5        = 5300         --HE Filler or Flechette count
    PlayerData.Data6        = 57         --HEAT ConeAng or Flechette Spread
    PlayerData.Data7        = 0
    PlayerData.Data8        = 0
    PlayerData.Data9        = 0
    PlayerData.Data10       = 1
