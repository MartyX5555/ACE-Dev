...
-- Weapon info		
SWEP.Purpose		= "Slavic sound thrower"	
SWEP.Instructions	= "Left mouse to shoot cool sounds"		
...
function SWEP:PrimaryAttack()		
	...
	--self.Weapon:EmitSound(Sound(self.Primary.Sound), 100, 100, 1, CHAN_WEAPON )	-- not cool
