...
function SWEP:InitBulletData()
    ...
    PlayerData.Type         = "AP"
    PlayerData.PropLength   = 1.35        --Volume of the case as a cylinder * Powder density converted from g to kg   
    PlayerData.ProjLength   = 1.6       --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
