...
function SWEP:InitBulletData()
    ...
    PlayerData.Type         = "AP"
    PlayerData.PropLength   = 12        --Volume of the case as a cylinder * Powder density converted from g to kg   
    PlayerData.ProjLength   = 5       --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
