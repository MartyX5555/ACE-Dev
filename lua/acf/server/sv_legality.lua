   ...
   function ACF_CheckLegal(Ent, Model, MinMass, MinInertia, _, CanVisclip )
      ...
      if ACF.Legal.Ignore.Mass <= 0 then
         ...
         if MinMass != nil and CMass < MinMass then
            print("[ACE|WARN]- The entity ("..Ent:GetClass()..") was Flagged as minmass due to current entity should be "..MinMass.." kgs as minimum, but it was "..CMass.." kgs instead. (Diff: "..(MinMass-CMass).." kgs)")
