...
ACF_defineGun("20mmAC", { --id
	...
	sound = "ace_weapons/20/close/close_multi.mp3",
	caliber = 2.0,
	gunclass = "AC",
	nomag = true,
	weight = 170,
...
ACF_defineGun("30mmAC", {
	...
	sound = "ace_weapons/30/close/close_multi.mp3",
	gunclass = "AC",
	nomag = true,
	caliber = 3.01,
	weight = 255,
...
ACF_defineGun("40mmAC", {
	...
	sound = "ace_weapons/40/close/close_multi.mp3",
	gunclass = "AC",
	nomag = true,
	caliber = 4.0,
	weight = 425,
...
ACF_defineGun("50mmAC", {
	...
	sound = "ace_weapons/50/close/close_multi.mp3",
	gunclass = "AC",
	nomag = true,
	caliber = 5.0,
	weight = 880,
...
ACF_defineGun("30mmHAC", {
    ...
    sound = "ace_weapons/30/close/close_multiclose_multi.mp3",
    gunclass = "AC",
    nomag = true,
    caliber = 3.0,
    weight = 700,
