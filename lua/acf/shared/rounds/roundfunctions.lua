...
function ACF_CalcCrateStats( CrateVol, RoundVol )
	local CapMul = (CrateVol > 40250) and ((math.log(CrateVol*0.0000081)/math.log(2)-4)*0.15+1) or 1
	local RoFMul = (CrateVol > 40250) and (1-(math.log(CrateVol*0.0000081)/math.log(2)-4)*0.05) or 1
